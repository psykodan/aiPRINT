...
models ={"line" : tf.keras.models.load_model('results-transfer/Xception_line.h5')
,"infill" : tf.keras.models.load_model('results-real/MobileNetV3Small_infill.h5')}
