...
picam = Picamera2()
config = picam.create_still_configuration(controls={'ExposureTime':1500,'AnalogueGain':7.0},main={"size":(1280,720)})
...
def camera_system():
    ...
    # Display the resulting frame 
        ...
        if print_start == True:
            if frame_num%15==0:
                data = invframe[boxy-box:boxy+box,boxx-box:boxx+box]
    ...
    for idx,g in enumerate(gcode):
        ...
        for gx in g.split(' '):
            if 'E' in gx:
                ...
                if idx > 2:
                    print(f'Control {extrusion_factor}')
